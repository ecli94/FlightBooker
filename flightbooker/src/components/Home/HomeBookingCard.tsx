...
const LocationsToContext = createContext<LocationToHandlerResponse | undefined>(
  undefined,
);
const LocationsFromContext = createContext<
  LocationFromHandlerResponse | undefined
>(undefined);
const PassengerContext = createContext<PassengerHandlerResponse | undefined>(
  undefined,
);
    ...
    <ClassContext.Provider value={{ ticketClasses, classDispatch }}>
      <PassengerContext.Provider value={{ travelers, passengerDispatch }}>
        <LocationsFromContext.Provider
          value={{ locationFrom, locationsFromDispatch }}
        >
          <LocationsToContext.Provider
            value={{ locationTo, locationsToDispatch }}
          >
...
const useHandler = <T extends HandlerResponse>(
...
const HomeBookingCard: React.FC = () => {
  ...
  const { locationFrom, locationsFromDispatch } =
    useHandler(LocationsFromContext);
        ...
        <div className={styles.passengerSelectVerticalMenu}>
          ...
          {travelers.map((t) => (
            <div className={styles.passengerRow}>
              ...
              <button
                className={styles.addPassengerColumn}
                onClick={() =>
                  passengerDispatch({ type: "ADD-PASSENGER", id: t.id })
                }
              >
                <span>+</span>
              </button>
    ...
    <div className={styles.centerColumn}>
      <div className={styles.bookRow}>
        ...
        {isFromCardVisible && (
          <div
            className={styles.overlay}
            onClick={() => setIsFromCardVisible(false)}
          >
            <div
              ref={fromCardRef}
              id="from"
        ...
        {isToCardVisible && (
          <div
            className={styles.overlay}
            onClick={() => setIsToCardVisible(false)}
          >
            <div
              ref={toCardRef}
              id="to"
        ...
        {isPassengerCardVisible && (
          <div
            className={styles.overlay}
            onClick={() => setIsPassengerCardVisible(false)}
          >
            <div
